...
def main() -> None:
    parser = argparse.ArgumentParser(description="Audit Bronze output for a Batdongsan crawl run.")
    parser.add_argument("--crawl-date", help="Crawl date in YYYY-MM-DD format. Defaults to latest date.")
    parser.add_argument("--crawl-id", help="Specific crawl_id to audit. Defaults to latest summary.")
